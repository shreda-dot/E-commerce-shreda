  ...
  return (
    ...
    >
      <Stack direction="row" spacing={1.5} sx={{ alignItems: 'center' }}>
        <Box
          sx={{
            width: { xs: 34, sm: 40 }, height: { xs: 34, sm: 40 }, borderRadius: '12px', flexShrink: 0,
        ...
        <Box sx={{ minWidth: 0 }}>
          <Typography sx={{ fontSize: { xs: '1.15rem', sm: '1.5rem' }, fontWeight: 900, lineHeight: 1, color: isDark ? '#f1f5f9' : '#0f172a', letterSpacing: '-0.03em' }}>
            {value}
          </Typography>
          <Typography sx={{ fontSize: { xs: '0.64rem', sm: '0.72rem' }, fontWeight: 600, color: isDark ? 'rgba(255,255,255,0.4)' : 'rgba(0,0,0,0.45)', mt: 0.2, whiteSpace: 'nowrap' }}>
            {label}
          </Typography>
        </Box>
      </Stack>
    ...
    <Box sx={{ minHeight: '100vh', background: t.pageBg, pb: 8, position: 'relative' }}>
      ...
      <Box sx={{ px: { xs: 2, md: 0 }, mb: 3 }}>
        <Stack
          direction="row"
          spacing={{ xs: 1, md: 1.5 }}
          sx={{ flexWrap: { xs: 'wrap', sm: 'nowrap' }, gap: { xs: 1, sm: 0 }, alignItems: 'stretch' }}
        >
      ...
      >
        ...
        >
          {[
            ...
            >
              {t2.icon}
              {!(isMobile && t2.label === 'Settings') && t2.label}
            </Box>
          ))}
        </Box>
      </Box>
            ...
            <Stack spacing={2.5}>
              ...
              <Stack direction={{ xs: "column", md: "row" }} spacing={2.5} sx={{ alignItems: { xs: "stretch", md: "center" }, justifyContent: "space-between" }}>
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={1}>
                  <Button onClick={() => setTab(1)} variant="outlined" sx={{ borderRadius: "10px", textTransform: "none", fontWeight: 700, width: { xs: '100%', sm: 'auto' } }}>
                    View Orders
                  </Button>
                  <Button onClick={() => setTab(3)} variant="contained" sx={{ borderRadius: "10px", textTransform: "none", fontWeight: 700, width: { xs: '100%', sm: 'auto' } }}>
                    Manage Settings
                  </Button>
                </Stack>
              </Stack>
      ...
      {tab === 3 && (
        ...
        >
          <GlassCard sx={{ p: { xs: 2.5, md: 3.5 }, maxWidth: 520, width: '100%' }}>
